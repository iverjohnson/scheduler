...
h=!0);var c=this._safe_copy(l);if(c.end_date=new Date(c.end_date),c.start_date<this._min_date?c.start_date=d(this._min_date,this.config.first_hour):c.start_date=d(r(l.start_date),this.config.first_hour),c.start_date<this._max_date&&c.start_date<c.end_date){if(!h){s[o--]=c;continue}s.splice(o+1,0,c)}}else s.splice(o--,1)}var u="move"==this._drag_mode?!1:a;return i.call(this,s,u)};var s=e.get_visible_events;e.get_visible_events=function(e){return this.config.all_timed&&this.config.multi_day?s.call(this,!1):s.call(this,e);
